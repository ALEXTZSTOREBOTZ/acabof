...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    let thumb = await(await fetch(cita)).buffer()
      let vn = './media/7113420964272147227.mp3'
   ...
   conn.sendButton(m.chat, `*${wish()}, ${name} 👋*`, text.trim(), await genProfile(conn, m), [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], false, { quoted: fkon, contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: "https://Instagram.com/alextz_store",
    mediaType: "./media/oyyehhhh3_1656307680_musicaldown.com.mp4",
    description: "https://Instagram.com/alextz_store", 
    title: 'Simple Bot Alex',
    body: wm,
    thumbnail: thumb,
    sourceUrl: sgc
}
